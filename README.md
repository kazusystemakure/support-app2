...
# 目指した課題解決
## スキマ健康で、広島を強くする。心と身体の健康 ＝ 人としての強さ。
## 休憩時間、在宅の合間、また家事や育児の合間のスキマ時間に運動することで、身体的健康と、ストレスマネジメントなど心の健康も目指す。
### 対象者 例）
### 在宅ワーク、仕事で精神的にも疲れが蓄積しているサラリーマン
### 働きながら家事と育児にこなし、疲労やストレスが解消しきれないママ
### 運動しないといけない。とは思いながらも、一人では継続できない方
### 自身のパフォーマンスに気をつかうアスリートやサラリーマン
### 上記のような人たちに対して、
## ・疲れやストレスを抱える人たちに、オンラインでの運動という形で、マネジメントしていく。（健康マネジメント）
## ・インストラクターも広島という物理的な親近感と、親しみのある雰囲気で、運動を楽しみながら継続。（継続サポート）
## ・仕事、家事、育児、男女関係なく、誰もが忙しい時代に、人は運動する時間をわざわざ取らない。スキマ時間を運動や健康で埋める習慣を提供する。（運動の日常化）

# 要件定義

| 機能            | 目的                                   | 詳細                                   |ストーリー（ユースケース）                     |
| ユーザー機能     | ユーザー登録/ログイン/ログアウト            | ユーザー新規登録、ログイン/ログアウト機能    | ・新規登録画面より、ユーザー登録               |
|                |                                        |                                       | ・画像、名前、フリガナ、email、パスワード、郵便番号,住所,電話番号, 生年月日を入力。|
|                |                                        |                                       |・インストラクター希望者は、プロフィール公開選択、種目/スキル 自己紹介を入力。|
|                |                                        |                                       |・ログイン画面よりemailとパスワードにてログイン   |
|レッスン追加機能   | ログインユーザーが新規レッスン追加          | 新規レッスン追加画面でレッスンの内容及び、   | ・レッスン画像、名前、運動量、説明、開催日時、価格入力。|
...
|レッスン購入機能   | ログインしたユーザーが、レッスンを購入。     | レッスン購入画面にて、カード情報を入力       | ・レッスン画像、名前、料金を表示を確認          |
|                | Zoom IDとPasswordを取得。               | 購入ボタンを押すと購入が完了。(PAYJP)       | ・カード情報入力（名前、カード番号、年月、CVC）   |
|                |                                        |                                       | ・購入ボタンを押すと購入完了                   |
...
|                | 自分の情報を確認可。                       | インストラクターは、種目、紹介文、SNS、     | ・インストラクターは、画像、名前、種目/スキル、自己紹介、SNS、開催レッスン一覧を表示。|
|                |                                        |  新規レッスン追加ボタンを表示              |          |
