...
### レッスン追加方法
#### インストラクターテストアカウントでログイン→トップページ→名前をクリックしマイページへ→マイページで新規レッスン追加ボタン押→レッスン追加情報入力→レッスン追加ボタン押
### レッスン購入方法
...
# 目指した課題解決
## 広島をスキマ時間で健康にする。
## 仕事の休憩時間の合間、家事や育児の合間の、スキマ時間に運動することで、身体的健康と、ストレスマネジメントなど心身の健康も含む。
### 対象者 例）
...
### 上記のような人たちに対して、
## ・疲れやストレスを抱える人たちに、オンライン運動という形で、マネジメントしていく。
## ・インストラクターも広島という物理的に親近感と親しみのある雰囲気で、レッスンを楽しみながら継続。（継続サポート）
## ・仕事、家事、育児、男女関係なく、誰もが忙しい時代に、運動する時間をわざわざ取らない。スキマ時間を運動や健康で埋める習慣を提供する。（運動の日常化）
